        ...
        <div className="container">
          ...
          >
            ...
            <motion.section variants={itemVariants} className="docs-section">
              ...
              <p>
                By accessing or using Roda (the "Platform"), you agree to be bound by these Terms of Service. If you do not agree to these terms, do not access or use the Platform. Roda is currently deployed on the <strong>Arc Network (Testnet)</strong> for educational and demonstration purposes.
              </p>
